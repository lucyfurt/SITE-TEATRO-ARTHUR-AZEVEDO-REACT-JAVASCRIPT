      ...
      <Row gutter={[16, 16]}>
        ...
        <Col xs={24} sm={12} lg={8}>
          ...
          >
            <Meta
              title="entreAto"
              description="O entreAto é um ciclo de formação que explora processos criativos em contexto de grupo e conhecimentos técnicos de uma casa de espetáculos, nos quais eles possam se retroalimentar no decorrer de sua experimentação."
            />
          </Card>
        </Col>
        <Col xs={24} sm={12} lg={8}>
