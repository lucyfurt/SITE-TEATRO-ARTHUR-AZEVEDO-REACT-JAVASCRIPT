...
import { Layout, Typography, Timeline, Carousel, Row, Col } from 'antd';
import { ClockCircleOutlined, StarOutlined, CheckOutlined } from '@ant-design/icons';
  ...
  return (
    <Layout>
          ...
          <Timeline.Item color="green">
            ...
            <Row justify="center">
              <Col xs={24} sm={16} md={12}>
                <Carousel autoplay>
                  <div>
                    <img src="https://i.ibb.co/XLHVTWB/0005.png" alt="Fundação" width={'100%'} />
                  </div>
                </Carousel>
              </Col>
            </Row>
          ...
          <Timeline.Item color="blue">
            ...
            <Row justify="center">
              <Col xs={24} sm={16} md={12}>
                <Carousel autoplay>
                  <div>
                    <img src="https://i.ibb.co/XLHVTWB/0005.png" alt="Apolônia Pinto" width={'100%'} />
                  </div>
                </Carousel>
              </Col>
            </Row>
          ...
          <Timeline.Item color="red">
            ...
            <Row justify="center">
              <Col xs={24} sm={16} md={12}>
                <Carousel autoplay>
                  <div>
                    <img src="https://i.ibb.co/XLHVTWB/0005.png" alt="Arthur Azevedo" width={'100%'} />
                  </div>
                </Carousel>
              </Col>
            </Row>
      ...
      <Footer style={{ background: '#6d0202', padding: '20px', textAlign: 'center', color: '#fff' }}>
        <Text strong>Teatro Arthur Azevedo</Text> © Todos os direitos reservados {new Date().getFullYear()}
      </Footer>
    </Layout>
  );
}
