                ...
                <Content className="Content">
                    <div className="image-container">
                        ...
                        <div className="text">
                            ...
                            <p>
                                O teatro foi construído entre os anos de 1816 e 1817 e foi inicialmente chamado de Theatro de São Luís. O projeto foi idealizado pelo então governador Bernardo de Sousa Franco, que buscava proporcionar à população um espaço dedicado às artes cênicas e à cultura em geral. Ao longo do tempo, o teatro passou por diversas reformas e modificações para atender às demandas e necessidades da época. No ano de 1884, o teatro foi reinaugurado e recebeu o nome de Theatro Arthur Azevedo em homenagem ao dramaturgo e jornalista maranhense Arthur Azevedo, uma das principais figuras da literatura e do teatro brasileiro naquele período.
                                Arthur Azevedo foi um importante dramaturgo, jornalista e escritor brasileiro, nascido em 7 de julho de 1855, em São Luís, no estado do Maranhão. Ele foi uma figura chave no cenário cultural e teatral do Brasil do final do século XIX e início do século XX.
                            </p>
