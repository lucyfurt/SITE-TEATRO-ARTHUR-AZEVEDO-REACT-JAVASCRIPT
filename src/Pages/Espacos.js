...
import { Layout, Typography, Tabs, Divider, Button, Card, Col, Row, Pagination } from 'antd';
...
" />
                ...
                <div style={{ display: 'flex', justifyContent: 'center', marginTop: '16px' }}>
                    ...
                    <Button style={{ marginRight: '8px', backgroundColor: '#67A4FB', borderColor: '#67A4FB', color: 'white' }}>Inscrever-se </Button>
