    ...
    <Layout>
      ...
      <Content style={{ padding: '50px' }}>
        <Tabs defaultActiveKey="1" type="card">
          <TabPane tab="História do NAE" key="1">
          ...
          <TabPane tab="Dança" key="2">
            ...
            <Carousel autoplay>
              <div>
                <img src="https://example.com/dance-image.jpg" alt="Dança" width={'100%'} />
              </div>
            </Carousel>
          </TabPane>
          <TabPane tab="Música" key="3">
            ...
            <Carousel autoplay>
              <div>
                <img src="https://example.com/music-image.jpg" alt="Música" width={'100%'} />
              </div>
            </Carousel>
          </TabPane>
          <TabPane tab="Teatro" key="4">
            ...
            <Carousel autoplay>
              <div>
                <img src="https://example.com/theater-image.jpg" alt="Teatro" width={'100%'} />
              </div>
            </Carousel>
          </TabPane>
          <TabPane tab="Núcleo Arte Educação" key="5">
            ...
            <Carousel autoplay>
              <div>
                <img src="https://example.com/nae-image.jpg" alt="Núcleo Arte Educação" width={'100%'} />
              </div>
            </Carousel>
          </TabPane>
        </Tabs>
