  ...
  return (
    <Layout>
      ...
      <Content style={{ padding: '50px' }}>
        ...
        <TabPane tab="Núcleo Arte Educação" key="1" style={{ fontSize:'24px' }}>
          ...
          <TabPane tab="História do NAE" key="2" style={{ fontSize:'24px' }}>
          ...
          <TabPane tab="Dança" key="3" style={{ fontSize:'24px' }}>
          ...
          <TabPane tab="Música" key="4" style={{ fontSize:'24px' }}>
          ...
          <TabPane tab="Teatro" key="5" style={{ fontSize:'24px' }}>
